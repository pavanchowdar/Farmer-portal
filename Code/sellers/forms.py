...
class SellerUserRegistrationForm(forms.ModelForm):
    name = forms.CharField(widget=forms.TextInput(attrs={'pattern': '[a-zA-Z]+'}), required=True, max_length=20)
    loginid = forms.CharField(widget=forms.TextInput(attrs={'pattern': '[a-z0-9]+'}), required=True, max_length=10)
